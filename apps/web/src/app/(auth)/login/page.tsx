  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-600 to-brand-800 p-12 flex-col justify-between">
        <div>
          <h1 className="text-4xl font-bold text-white">Turn any moment into a sale</h1>
        ...
        <div className="space-y-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-white font-medium">Platforms Supported</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-full bg-white/10 flex items-center justify-center">
            ...
            <div>
              <p className="text-white font-medium">Creator Revenue</p>
            </div>
          </div>
          <p className="text-brand-200 text-sm">Trusted by 1000+ creators worldwide</p>
        </div>
      </div>
